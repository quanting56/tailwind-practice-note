const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/TailwindPluginTypographyDemo-D-bJO7eg.js","assets/TailwindPluginTypographyDemo-WiajYEHw.css","assets/TailwindHomePageCardDemo-CR20NUuJ.js","assets/Kodak_Tmax400_007-DEfP2Vhj.js","assets/vue-BkpJVFS1.js","assets/TailwindMemberCardDemo-_wjgmt2y.js","assets/TailwindArticleCardDemo-DgnnzZXM.js","assets/TailwindMessageBoardDemo-CgfdWX5V.js","assets/TailwindDoubleSidedMultipleCardsDemo-Dhvahoqp.js"])))=>i.map(i=>d[i]);
...
<style scoped></style>`}},{detailTitle:`登入頁面`,detailSubtitle:null,detailContent:null,detailComponent:mr(()=>Ds(()=>import(`./TailwindPluginLoginPageDemo-DoTlmPQa.js`),[])),detailCode:{terminalCode:null,htmlCode:null,cssCode:null,jsCode:null,vueCode:`<template>
...
<div>
  ...
  ...
</div>`,cssCode:null,jsCode:null,vueCode:null}}]},{listTitle:`一個例子`,listSubtitle:null,listComponent:mr(()=>Ds(()=>import(`./TailwindDarkModeDemo-DJkGcHE9.js`),[])),listCode:{terminalCode:null,htmlCode:null,cssCode:null,jsCode:null,vueCode:`<template>
...
<style scoped></style>`}},{detailTitle:`多張翻轉卡片`,detailSubtitle:null,detailContent:null,detailComponent:mr(()=>Ds(()=>import(`./TailwindDoubleSidedMultipleCardsDemo-Dhvahoqp.js`),__vite__mapDeps([8,3,4]))),detailCode:{terminalCode:null,htmlCode:null,cssCode:null,jsCode:null,vueCode:`<template>
